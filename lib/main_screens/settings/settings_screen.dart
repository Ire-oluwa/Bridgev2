                ...
                SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      MyListTiles(leading: SvgPicture.asset("images/settings/document.svg"), title: MyText(text: kDocumentUpload, fontSize: 17.sp, fontWeight: kSemiBold,), onTap: (){},),
                      MyListTiles(leading: SvgPicture.asset("images/settings/bank.svg"), title: MyText(text: kWithdrawalBank, fontSize: 17.sp, fontWeight: kSemiBold,), onTap: (){},),
                      MyListTiles(leading: SvgPicture.asset("images/settings/privacy_and_policy.svg"), title: MyText(text: kTermsAndPrivacy, fontSize: 17.sp, fontWeight: kSemiBold,), onTap: (){},),
                      MyListTiles(leading: SvgPicture.asset("images/settings/help_and_support.svg"), title: MyText(text: kHelpAndSupport, fontSize: 17.sp, fontWeight: kSemiBold,), onTap: (){},),
